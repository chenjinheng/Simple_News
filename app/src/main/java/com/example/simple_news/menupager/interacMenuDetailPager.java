...
import com.example.simple_news.utils.BitmapCacheUtils;
import com.example.simple_news.utils.CacheUtils;
import com.example.simple_news.utils.Constants;
import com.example.simple_news.utils.NetCacheUtils;
...
public class interacMenuDetailPager extends MenuDetaiBasePager{
    ...
    public interacMenuDetailPager(Context context,NewsBean.DataBean detailPagerData) {
        super(context);
